...
void main()
{
	...
	char u[15],p[15];        //u= to scan username from file
				//p= to scan password from file
	
	FILE *f1;               //to scan username and password
